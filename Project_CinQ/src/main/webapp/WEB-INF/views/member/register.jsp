...
<body>
   ...
   <div class="wrap">
		...
		<div>
			<input type="text" name="email" id="email" onkeyup="javascript:checkEmail()"  placeholder="이메일 입력"><!--pattern="^[a-z0-9\.\-_]+@([a-z0-9\-]+\.)+[a-z]{2,6}$"  -->
			<label class="labelOk" id="emailLabel1" for="email"> OK </label>
			<label class="labelFail" id="emailLabel2" for="email"> 이메일을 입력하세요! </label>
		</div>
		<div>	
			<input type="text" id="tel1" name="tel1" value="010" size="2" readonly>
			<input type="text" id="tel2" name="tel2" maxlength="4" size="2" ><!--pattern="^[0-9]+$"  -->
			<input type="text" id="tel3" name="tel3" onkeyup="javascript:checkTel()" maxlength="4" size="2" ><!--pattern="^[0-9]+$"  -->
		...
		<div>	
			<input type="text" name="birthday" onkeyup="javascript:checkBd()" maxlength="8"  placeholder="생일 입력"> <!--pattern="^[0-9]+$"  -->
